            ...
            <div class="col-sm-12 col-lg-10 ">
              <div class="panel panel-primary">
                ...
                while($row=$query->fetch_assoc()){
                  ?>
                  <h3>ประวัติบันทึกการเข้าชั้นเรียนวิชา <?php echo $row['Subject_NameTH']  ?> กลุ่ม <?php echo $group_id; ?></h3>
                  <?php
                }
                  ?>
                </div>
                <div class="panel-body">
                  ...
                  <div class="col-lg-2"> 
                   <?php
                $sql1 = "SELECT DISTINCT date FROM studentlist where subject_id = '$subject_id' AND group_id ='$group_id'";
                $query = $connect->query($sql1);
                while($rows=$query->fetch_assoc()){
                  ?>
                  <a  href="mysubject-checkhistory-view.php?group_id=<?php echo $group_id; ?>&subject_id=<?php echo $subject_id; ?>&date1=<?php echo $rows['date'] ?>" class="btn btn-default btn-lg"><?php echo $rows['date'] ?></a>
                 <br><br>
                  <?php } ?>
                   </div> 
                  </div>
