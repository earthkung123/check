                                    ...
                                    <table class="table table-striped table-bordered" id="dataTables-example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr valign='top'>
                                                ...
                                                <form name="edit" method="post" action="teacher-view-editdata.php">
                                            ...
                                            <td><form name="deledt1" method="post" action="deletedata.php">
                                                <input type="hidden" name="Teacher_ID" value="<?php echo $arr['Teacher_ID'] ?>"/>
                                                <input type="submit" value="ลบข้อมูล" class="btn btn-danger btn-mi"  onclick="return confirm('คุณต้องการที่จะลบข้อมูล <?php echo $arr['Teacher_Titlename']." ".$arr['Teacher_NameTH'] ?> หรือไม่ ?')"/>
                                            </form></td>
                                        </tr>
                                        <?php }?>
                                    </tbody>
